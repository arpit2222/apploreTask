...
function main(props) {
  ...
  const [userInfo,setUserInfo] = useState('')
    ...
    useEffect(()=>{
        ...
        setSelectedU(storedUser.id)
        console.log("admin_id",storedUser.id)
              ...
              <Box>
                <div role="presentation" onClick={handleClick}>
                  <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography color="text.primary">Writer Blogs</Typography>
                  </Breadcrumbs>
                </div>
              </Box>
            </Box> 
                ...
                <Box className="flex justify-between mb-4">
                  ...
                  <Box sx={{ minWidth: 120 }}>
                    <FormControl fullWidth>
                      ...
                      >
                      <MenuItem value={userInfo._id}>{userInfo.pen_name}</MenuItem>
                        {
                        users.map((singleUser,index)=>(
                          <MenuItem key={index} value={singleUser._id}>{singleUser.pen_name}</MenuItem>
                        ))
                      }
                    ...
                    <TableBody>
                      {
                        blogs.map((singleBlog,index)=>(
                          singleBlog.status && singleBlog.user_id==selectedU ?
